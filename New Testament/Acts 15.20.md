...
> But that we write unto them, that they <u>abstain</u>[^a] from <u>pollutions</u>[^b] of idols, and <i>from</i> <u>fornication</u>[^c], and <i>from</i> things strangled, and <i>from</i> <u>blood</u>[^d].
